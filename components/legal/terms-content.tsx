  ...
  return (
    <article className="prose prose-invert max-w-none">
      <header className="not-prose mb-8 border-b border-border pb-6">
        ...
        <p className="mt-2 text-muted-foreground">Please read them carefully.</p>
      </header>
      ...
      <p>
        This website-hosted user interface (this &ldquo;Interface&rdquo;) is a frontend software
        portal to the Conceal Network protocol, a decentralized and community-driven blockchain and
        tools (the &ldquo;Protocol&rdquo;). This Interface is made available by the Conceal Network
        community. (&ldquo;Conceal Network&rdquo;). However, all transactions conducted on the
        Protocol are run as part of a permissionless layer-1 blockchain. As the Protocol is
        accessible by any user, entity or third party, there may be a number of third-party web and
        mobile user-interfaces that allow for interaction with the Protocol. YOUR USE OF THE
        INTERFACE AND PROTOCOL ARE ENTIRELY AT YOUR OWN RISK.
      </p>

      <h2>No Warranty</h2>
      <p>
        THE INTERFACE IS AVAILABLE ON AN &ldquo;AS IS&rdquo; BASIS WITHOUT WARRANTIES OF ANY KIND,
        EITHER EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, WARRANTIES OF MERCHANTABILITY,
        TITLE, FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT.
      </p>
      <p>
        You assume all risks associated with using the Interface, and digital assets and
        decentralized systems generally, including but not limited to, that: (a) digital assets are
        highly volatile; (b) using digital assets is inherently risky due to both features of such
        assets and the potential unauthorized acts of third parties; (c) you may not have ready
        access to assets; and (d) you may lose some or all of your tokens or other assets. You agree
        that you will have no recourse against anyone else for any losses due to the use of the
        Interface. For example, these losses may arise from or relate to: (i) incorrect information;
        (ii) software or network failures; (iii) corrupted cryptocurrency wallet files; (iv)
        unauthorized access; (v) errors, mistakes, or inaccuracies; or (vi) third-party activities.
        Accordingly, you understand and agree to assume full responsibility for all of the risks of
      ...
      <p>
        ...
        will solely be through your public digital wallet address. Any personal or other data that
        you may make available in connection with the Protocol may not be private or secure.
      </p>
      ...
      <ul className="list-none space-y-4 pl-0">
        ...
        <li>
          ...
          network, personal device, or other information technology system, including (but not
          limited to) the deployment of viruses and denial of service attacks.
        </li>
        <li>
          <strong className="text-primary">Fraud and Misrepresentation.</strong> Activity that seeks
          to defraud us or any other person or entity, including (but not limited to) providing any
          false, inaccurate, or misleading information in order to unlawfully obtain the property of
          another.
        </li>
        <li>
          <strong className="text-primary">Market Manipulation.</strong> Activity that violates any
          applicable law, rule, or regulation concerning the integrity of trading markets, including
          (but not limited to) the manipulative tactics commonly known as spoofing and wash trading.
        </li>
        <li>
          <strong className="text-primary">Any Other Unlawful Conduct.</strong> Activity that
          violates any applicable law, rule, or regulation.
        </li>
      </ul>

      <h2>No profesional advice</h2>
      <p>
        All information provided by the Interface is for informational purposes only and should not
        be construed as professional advice. You should not take, or refrain from taking, any action
        based on any information contained in the Interface. Before you make any financial, legal,
        or other decisions involving the Interface, you should seek independent professional advice
        from an individual who is licensed and qualified in the area for which such advice would be
        appropriate.
      </p>

      <h2>Additional programs</h2>
      <p>
        Conceal Network may, from time to time, in its sole discretion, make certain programs,
        special offers, challenges, bonuses, or other promotions available to participants. The
        terms and conditions applicable to any such special offers will be determined by Conceal
        Network in its sole discretion and communicated to participants in conjunction with any such
        programs. Because any terms and conditions associated with any special offers may be
        different from or in addition to provisions of these Terms of Use, you should read any such
        additional terms and conditions carefully before participating in any program.
      </p>
      ...
      <p>
        ...
        participation in any feature on the Interface in its sole discretion, including if Conceal
        Network determines or suspects that your use of the Interface is unauthorized, deceptive,
        fraudulent, unlawful, or intentionally subverts the purposes of the Interface.
      </p>
      <p>
        To the extent that Conceal Network provides access to a points or other similar promotional
        program, your accumulation of points has no cash value. If you have a right to claim any
        rewards or other items in association with a promotional program, you may be subject to
      ...
      <p>
        ...
        Interface and your interaction with the Protocol. You further expressly waive and release us
      ...
      <p>
        ...
        with this Agreement shall be finally settled under the Rules of Arbitration of the
        International Chamber of Commerce by one arbitrator appointed in accordance with the said
        Rules. The rules are available at the iccwbo.org website (
        <a href="https://iccwbo.org/dispute-resolution-services/arbitration/rules-of-arbitration/">
          https://iccwbo.org/dispute-resolution-services/arbitration/rules-of-arbitration/
        </a>{" "}
        or such updated link). The place of arbitration shall be Singapore. The language of the
        arbitration shall be English. Judgment on the award rendered by the arbitrator(s) may be
        entered by any court having jurisdiction thereof or having jurisdiction over the relevant
        party or its assets.
      </p>
      <p>
