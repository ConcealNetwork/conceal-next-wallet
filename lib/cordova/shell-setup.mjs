...
/**
 * A plugin spec that is NOT a registry version range — a local path, file: dir,
 * tarball, or git URL — must be passed to `cordova plugin add` verbatim.
 * Prefixing it with `<id>@` (e.g. `cordova-plugin-biometric-unlock@file:…`)
 * produces a malformed spec that Cordova cannot resolve.
 */
