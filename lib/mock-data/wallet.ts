...
export const mockWalletInfo: WalletInfo = {
  ...
  incomingPending: ccxAmount(8.5), // #109 — owned mempool funds not yet mined (demo value)
...
export const mockMessages: Message[] = [
  ...
  },
  {
    ...
    unread: true,
    paymentIdFrom: "b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2",
    paymentIdTo: null,
    blockHeight: 1971170,
    threadKey: "alice-pulse",
  },
  {
    id: "msg-003b",
    direction: "received",
...
export const mockAddressBook: AddressEntry[] = [
  ...
  },
  {
    ...
    paymentId: "b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2b2",
    paymentIdTo: "a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2",
    relationship: true,
    avatar: "alice",
  },
  {
...
export const mockNodeStatus: NodeStatus = {
  ...
  tipBlockAgeHistory: [124, 117, 121, 113, 119, 110, 122, 118],
};
