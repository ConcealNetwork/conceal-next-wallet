...
describe("formatWalletBackupMarkdown", () => {
  it("formats mnemonic and keys as markdown sections", () => {
    ...
    expect(markdown).toContain("## Public address:");
    expect(markdown).toContain("ccx7QbH7J9PpM5rK2sL8nV4xA1zC6eT3wY9uD2fG5hJ8kL1mN4pQ7rS9tV2wX5yZ8aB1cD4eF7gH0jK3m");
    expect(markdown).toContain("## Creation Height");
